export default {
  ...
  projects: {
    ...
    items: {
      ...
      streaming: {
        title: 'Signal — Streaming Platform',
        description:
          'Cinema-style streaming demo: React + TypeScript UI backed by a Django REST API. Token auth, multi-profile accounts, catalog home/movies/series/search, My List, continue watching, custom video player, and light/dark theming — full-stack from browse shell to profile-scoped list APIs.',
      },
      social: {
  ...
  contact: {
    ...
    form: {
      email: 'Email',
      message: 'Message',
      messagePlaceholder: 'Tell me about the role or what you’re building…',
      messageHint: 'A short note is perfect.',
      messageProgress: '{count} more characters',
      messageReady: 'Looks good',
      messageAtLimit: 'Character limit reached',
      submit: 'Send message',
      sending: 'Sending…',
      orEmail: 'or',
      ...
      draftTitle: 'Draft opened',
      draftBody: 'Your mail app has a pre-filled message. Send it from there, or try the form again.',
      sendAnother: 'Send another',
      error: 'Couldn’t send. Reach me at',
      errors: {
        emailRequired: 'Add your email',
        emailInvalid: 'That email doesn’t look right',
        messageRequired: 'Add a short message',
        messageShort: 'A little more detail helps',
        messageLong: 'Keep it under 1,000 characters',
      },
    },
  },
  footer: {
