export default {
  ...
  projects: {
    ...
    items: {
      ...
      streaming: {
        title: 'Signal — Plateforme de streaming',
        description:
          'Démo streaming style cinéma : UI React + TypeScript branchée sur une API Django REST. Auth par token, comptes multi-profils, catalogue (accueil/films/séries/recherche), Ma liste, reprise de lecture, lecteur vidéo custom et thèmes clair/sombre — full-stack du shell de navigation aux APIs de listes par profil.',
      },
      social: {
  ...
  contact: {
    ...
    form: {
      email: 'E-mail',
      message: 'Message',
      messagePlaceholder: 'Parlez-moi du poste ou de ce que vous construisez…',
      messageHint: 'Une courte note suffit.',
      messageProgress: 'encore {count} caractères',
      messageReady: 'Parfait',
      messageAtLimit: 'Limite de caractères atteinte',
      submit: 'Envoyer',
      sending: 'Envoi…',
      orEmail: 'ou',
      ...
      draftTitle: 'Brouillon ouvert',
      draftBody: 'Votre messagerie a un message prérempli. Envoyez-le depuis là, ou réessayez le formulaire.',
      sendAnother: 'Envoyer un autre',
      error: 'Échec de l’envoi. Écrivez-moi à',
      errors: {
        emailRequired: 'Ajoutez votre e-mail',
        emailInvalid: 'Cet e-mail ne semble pas correct',
        messageRequired: 'Ajoutez un court message',
        messageShort: 'Un peu plus de détail aide',
        messageLong: 'Maximum 1 000 caractères',
      },
    },
  },
  footer: {
